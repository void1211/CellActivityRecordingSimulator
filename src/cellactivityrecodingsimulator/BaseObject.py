...
class BaseObject():
    ...
    @x.setter
    def x(self, value):
        v = self._check_position(value, self._y, self._z)
        assert v, "Invalid position"
    ...
    @y.setter
    def y(self, value):
        v = self._check_position(self._x, value, self._z)
        assert v, "Invalid position"
    ...
    @z.setter
    def z(self, value):
        v = self._check_position(self._x, self._y, value)
        assert v, "Invalid position"
